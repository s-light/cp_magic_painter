...
#                 value = self._configparser_get_converted(cp, section, option)
...
#             filename_ext = os.path.splitext(self.filename)[1]
#             if filename_ext is not "" and filename_ext in ".json .js":
#                 self._write_to_json_file(self.filename, self.config)
#             else:
#                 self._write_to_ini_file(self.filename, self.config)
#
